...
\begin{table}[H]
	\begin{tabular}{ccc|c}
		...
		STO-3G   & -0.114 &	-71.54 & \\ 
		4-31G    & -0.114 &	-71.54 & \\
		6-31G*   & -0.088 &	-55.22 & exoergic\\
		6-31G**  & -0.095 &	-59.61 &\\
		HF-limit & -0.097 &	-60.87 &\\
		\hline	
	\end{tabular}
\end{table}
The contribution of zero-point vibrations to the energy change of reaction I would be $ \SI{19.03}{kcal/mol} $, to the energy change of reaction II would be $ \SI{17.78}{kcal/mol} $. Thus the effect of zero-point vibrations should not be ignored.
